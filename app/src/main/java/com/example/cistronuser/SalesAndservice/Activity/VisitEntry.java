...
public class VisitEntry extends AppCompatActivity {
    ...
    private void CallAdd(String hospitalID, String chefDocID, String productId) {
        ...
        visitEntryAddInterface.CallAddVisitEntry("addVisitEntry",hospitalID,chefDocID,productId,EdComment.getText().toString(),ip,tvDate.getText().toString(),PreferenceManager.getEmpID(this)).enqueue(new Callback<VisitEntryAddResponse>() {
            @Override
