...
public class MyStockAdapter extends RecyclerView.Adapter<MyStockAdapter.ViewHolder> {
    ...
    public MyStockAdapter(Activity activity, ArrayList<MyStockSEModel> myStockSEModels) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyStockAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.rbStock.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    mystockListAdapter = new MystockListAdapter(activity, myStockListSEModels);
    ...
    private void CallMystockList(String seriesId) {
        ...
        myStockListSEInterface.CallMystock("myStock", PreferenceManager.getEmpID(activity), seriesId).enqueue(new Callback<MyStockListSEResponse>() {
            @Override
