...
public class CreateSpareReqSearchAdapter extends RecyclerView.Adapter<CreateSpareReqSearchAdapter.ViewHolder> {
    ...
    public CreateSpareReqSearchAdapter(ArrayList<MyStockSESearchModel> myStockListSEModels, Activity activity) {
    ...
    @NonNull
    @Override
    public CreateSpareReqSearchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.create_spare_req_search_adapter, parent, false);
        return new CreateSpareReqSearchAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull CreateSpareReqSearchAdapter.ViewHolder holder, int position) {
