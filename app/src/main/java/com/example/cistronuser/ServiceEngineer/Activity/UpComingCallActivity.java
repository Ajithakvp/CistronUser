...
public class UpComingCallActivity extends AppCompatActivity {
    ...
    private void CallUpcomingCallList() {
        ...
        upcomingCallListInterface.CallUpcomingCallReport("getCallsRecords", PreferenceManager.getEmpID(this),"upcoming").enqueue(new Callback<UpcomingCallListResponse>() {
            @Override
