...
public interface CallReportingUpComingSubmitInterface {
    ...
    //http://192.168.29.173/beta1/app/callClose.php?action=callclose&callregid=19087&callassignid=26287&
    ...
    Call<CallReportingUpComingSubmitResponse> callReportSubmit(@Query("action")String action,
                                                               ...
                                                               @Query("homelat") String homelat,
                                                               @Query("homelng") String homelng,
