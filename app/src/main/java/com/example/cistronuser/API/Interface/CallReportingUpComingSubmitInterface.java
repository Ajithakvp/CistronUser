...
public interface CallReportingUpComingSubmitInterface {
    ...
    Call<CallReportingUpComingSubmitResponse> callReportSubmit(@Query("action")String action,
                                                               ...
                                                               @Query("call_type_details")String call_type_details,
                                                               @Query("calltyp")String calltyp,
                                                               ...
                                                               @Query("balinspayamt")String balinspayamt,
                                                               @Query("cf")String cf,
                                                               ...
                                                               @Query("otp_name")String otp_name,
                                                               @Query("otp_des")String otp_des,
                                                               @Query("otp_mobile")String otp_mobile,
